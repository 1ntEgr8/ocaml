(* use refcounting fully naively *)
(* > ./boot/ocamlrun ./ocamlopt -I ./stdlib -S -O2 -g -o rbtree_rc0 my/rbtree_rc0.ml
*)
open Obj
...
| Node (_, Node (Red, l, kx, vx, r1), ky, vy, r2) -> 
  ...
  let kx = rc_dup_copy kx in
  let vx = rc_dup_copy vx in
  let ky = rc_dup_copy ky in
  let vy = rc_dup_copy vy in
  my_drop n;
